...
import { QuestionerController } from './controllers/QuestionerController';
...
//   public model: IModel;
  ...
  private routes() {
    ...
    console.log(chalk.default.yellow.bgBlack.bold(`Loading questioner- controller routes on port ${process.env.PORT}`));
    new QuestionerController().loadRoutes('/questioner', router);
